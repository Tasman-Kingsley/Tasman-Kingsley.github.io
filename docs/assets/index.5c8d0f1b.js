import{S as C,i as P,s as S,e as u,a as h,b as q,n as y,c as G,d as N,f as H,g as W,h as L,j as D,k as c,l as A,m as se,r as te,t as X,o as _,p as j,q as R,u as V,v as ie,w as Z,x as K,y as Y,z as I}from"./vendor.80efd210.js";const ae=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&t(n)}).observe(document,{childList:!0,subtree:!0});function s(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerpolicy&&(l.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?l.credentials="include":i.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function t(i){if(i.ep)return;i.ep=!0;const l=s(i);fetch(i.href,l)}};ae();function ne(a){let e,s;return{c(){e=u("div"),e.innerHTML=`<p>Hello, Tasman here. This is my portfolio page.</p> 
    ...
    You can contact me at <a href="mailto: tasmankingsley@gmail.com" style="color: #d3c7b8;">tasmankingsley@gmail.com</a></p>`,h(e,"class","content-div svelte-19x6bx6")},m(t,i){q(t,e,i)},p:y,i(t){s||G(()=>{s=N(e,H,{x:-400,duration:500}),s.start()})},o:y,d(t){t&&W(e)}}}class me extends C{constructor(e){super();P(this,e,null,de,S,{})}}var fe="/assets/waves.e979ddb3.jpeg";const{window:B}=ie;function ee(a){let e,s,t,i,l,n,w,d,M,f,z,g,k,$,O;return{c(){e=u("div"),s=u("div"),s.innerHTML='<span class="btn-txt svelte-1cyzmn1">Home</span>',t=L(),i=u("div"),i.innerHTML='<span class="btn-txt svelte-1cyzmn1">Code projects</span>',l=L(),n=u("div"),n.innerHTML='<span class="btn-txt svelte-1cyzmn1">Design portfolio</span>',w=L(),d=u("div"),d.innerHTML='<span class="btn-txt svelte-1cyzmn1">Music</span>',M=L(),f=u("div"),f.innerHTML='<span class="btn-txt svelte-1cyzmn1">About</span>',h(s,"class","nav-btn svelte-1cyzmn1"),h(i,"class","nav-btn svelte-1cyzmn1"),h(n,"class","nav-btn svelte-1cyzmn1"),h(d,"class","nav-btn svelte-1cyzmn1"),h(f,"class","nav-btn svelte-1cyzmn1"),h(e,"class","nav svelte-1cyzmn1"),D(e,"background-image","url("+fe+")")},m(m,o){q(m,e,o),c(e,s),c(e,t),c(e,i),c(e,l),c(e,n),c(e,w),c(e,d),c(e,M),c(e,f),k=!0,$||(O=[A(s,"click",a[8]),A(i,"click",a[9]),A(n,"click",a[10]),A(d,"click",a[11]),A(f,"click",a[12])],$=!0)},p:y,i(m){k||(G(()=>{g&&g.end(1),z=N(e,H,{x:400,duration:500}),z.start()}),k=!0)},o(m){z&&z.invalidate(),g=se(e,H,{x:400,duration:500}),k=!1},d(m){m&&W(e),m&&g&&g.end(),$=!1,te(O)}}}function ge(a){let e,s;return e=new me({}),{c(){K(e.$$.fragment)},m(t,i){Y(e,t,i),s=!0},i(t){s||(_(e.$$.fragment,t),s=!0)},o(t){j(e.$$.fragment,t),s=!1},d(t){I(e,t)}}}function ve(a){let e,s;return e=new he({}),{c(){K(e.$$.fragment)},m(t,i){Y(e,t,i),s=!0},i(t){s||(_(e.$$.fragment,t),s=!0)},o(t){j(e.$$.fragment,t),s=!1},d(t){I(e,t)}}}function be(a){let e,s;return e=new pe({}),{c(){K(e.$$.fragment)},m(t,i){Y(e,t,i),s=!0},i(t){s||(_(e.$$.fragment,t),s=!0)},o(t){j(e.$$.fragment,t),s=!1},d(t){I(e,t)}}}function ye(a){let e,s;return e=new oe({}),{c(){K(e.$$.fragment)},m(t,i){Y(e,t,i),s=!0},i(t){s||(_(e.$$.fragment,t),s=!0)},o(t){j(e.$$.fragment,t),s=!1},d(t){I(e,t)}}}function ke(a){let e,s;return e=new re({}),{c(){K(e.$$.fragment)},m(t,i){Y(e,t,i),s=!0},i(t){s||(_(e.$$.fragment,t),s=!0)},o(t){j(e.$$.fragment,t),s=!1},d(t){I(e,t)}}}function _e(a){let e=!1,s=()=>{e=!1},t,i,l,n,w,d,M,f,z,g,k=a[0][0].visible?"\u2715":"\u2630",$,O,m,o,v,T,E,F;G(a[7]);let p=a[0][0].visible&&ee(a);const Q=[ke,ye,be,ve,ge],x=[];function U(r,b){return r[0][1].visible?0:r[0][2].visible?1:r[0][3].visible?2:r[0][4].visible?3:r[0][5].visible?4:-1}return~(o=U(a))&&(v=x[o]=Q[o](a)),{c(){i=u("div"),p&&p.c(),l=L(),n=u("div"),w=u("span"),d=X(a[2]),M=L(),f=u("span"),f.textContent="\u262F",z=L(),g=u("span"),$=X(k),O=L(),m=u("div"),v&&v.c(),h(w,"class","title svelte-1cyzmn1"),h(f,"class","mode svelte-1cyzmn1"),h(f,"style",""),h(n,"class","header svelte-1cyzmn1"),D(n,"background-color",a[3]?"#191a22":"#eee"),D(n,"color",a[3]?"#eee":"#1e1f29"),h(g,"class","burg svelte-1cyzmn1"),D(g,"color",a[3]?"#fff":"#1e1f29"),h(m,"class","content svelte-1cyzmn1")},m(r,b){q(r,i,b),p&&p.m(i,null),c(i,l),c(i,n),c(n,w),c(w,d),c(n,M),c(n,f),c(i,z),c(i,g),c(g,$),c(i,O),c(i,m),~o&&x[o].m(m,null),T=!0,E||(F=[A(B,"scroll",()=>{e=!0,clearTimeout(t),t=setTimeout(s,100),a[7]()}),A(f,"click",a[6]),A(g,"click",a[4])],E=!0)},p(r,[b]){b&2&&!e&&(e=!0,clearTimeout(t),scrollTo(B.pageXOffset,r[1]),t=setTimeout(s,100)),r[0][0].visible?p?(p.p(r,b),b&1&&_(p,1)):(p=ee(r),p.c(),_(p,1),p.m(i,l)):p&&(Z(),j(p,1,1,()=>{p=null}),R()),(!T||b&4)&&V(d,r[2]),(!T||b&8)&&D(n,"background-color",r[3]?"#191a22":"#eee"),(!T||b&8)&&D(n,"color",r[3]?"#eee":"#1e1f29"),(!T||b&1)&&k!==(k=r[0][0].visible?"\u2715":"\u2630")&&V($,k),(!T||b&8)&&D(g,"color",r[3]?"#fff":"#1e1f29");let J=o;o=U(r),o!==J&&(v&&(Z(),j(x[J],1,1,()=>{x[J]=null}),R()),~o?(v=x[o],v||(v=x[o]=Q[o](r),v.c()),_(v,1),v.m(m,null)):v=null)},i(r){T||(_(p),_(v),T=!0)},o(r){j(p),j(v),T=!1},d(r){r&&W(i),p&&p.d(),~o&&x[o].d(),E=!1,te(F)}}}function we(a,e,s){let t=[{name:"Nav",visible:!1},{name:"Tasman Kingsley",visible:!0},{name:"Code projects",visible:!1},{name:"Design portfolio",visible:!1},{name:"Music project",visible:!1},{name:"About",visible:!1}],i,l=t[1].name,n=!0;function w(){s(0,t[0].visible=!t[0].visible,t)}function d(m){for(let o=1;o<t.length-1;o++)s(0,t[o].visible=!1,t);s(0,t[m].visible=!0,t),s(2,l=t[m].name),s(0,t[0].visible=!t[0].visible,t)}function M(){s(3,n=!n),window.document.body.classList.toggle("light")}function f(){s(1,i=B.pageYOffset)}return[t,i,l,n,w,d,M,f,()=>d(1),()=>d(2),()=>d(3),()=>d(4),()=>d(5)]}class Te extends C{constructor(e){super();P(this,e,we,_e,S,{})}}new Te({target:document.getElementById("app")});
