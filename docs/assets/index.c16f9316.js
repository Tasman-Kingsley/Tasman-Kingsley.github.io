import{w as le,S,i as C,s as N,e as o,a as q,b as c,c as A,d as z,f as r,l as j,n as M,g as I,h as Y,j as P,k as O,r as X,m as E,o as x,p as ce,t as te,q as D,u as H,v as se,x as ie,y as pe,z as de,A as ae,B as F,C as K,D as V}from"./vendor.7384cd90.js";const ue=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function i(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerpolicy&&(n.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?n.credentials="include":s.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(s){if(s.ep)return;s.ep=!0;const n=i(s);fetch(s.href,n)}};ue();let W=le([{name:"Nav",visible:!1},{name:"Tasman Kingsley",visible:!0},{name:"Web app projects",visible:!1},{name:"Website projects",visible:!1},{name:"Design portfolio",visible:!1},{name:"Music project",visible:!1},{name:"About",visible:!1}]),B=le("");var he="/assets/apps.2489986f.jpg",me="/assets/giddy-grocery.e94d6cec.jpg",fe="/assets/persona-collage.c8b1d3c9.jpg",oe="/assets/waves.e979ddb3.jpeg";function ge(a){let e,i,t,s,n,l,_,p,w,d,f,g,T,y,$,h,u,b;return{c(){e=o("div"),i=o("div"),i.innerHTML=`<p class="svelte-pfeueb">Hello, Tasman here. This is my portfolio page.</p> 
        <p class="svelte-pfeueb">Feel free to potter about and peruse my projects if you feel like it \u{1F601}</p>`,t=q(),s=o("div"),n=o("div"),l=o("div"),l.innerHTML='<span class="svelte-pfeueb">Web apps</span>',_=q(),p=o("div"),w=o("div"),w.innerHTML='<span class="svelte-pfeueb">Websites</span>',d=q(),f=o("div"),g=o("div"),g.innerHTML='<span class="svelte-pfeueb">Design porfolio</span>',T=q(),y=o("div"),$=o("div"),$.innerHTML='<span class="svelte-pfeueb">About</span>',c(l,"class","card-txt svelte-pfeueb"),c(n,"class","img svelte-pfeueb"),A(n,"background-image","url("+he+")"),c(w,"class","card-txt svelte-pfeueb"),c(p,"class","img svelte-pfeueb"),A(p,"background-image","url("+me+")"),c(g,"class","card-txt svelte-pfeueb"),c(f,"class","img svelte-pfeueb"),A(f,"background-image","url("+fe+")"),c($,"class","card-txt svelte-pfeueb"),c(y,"class","img svelte-pfeueb"),A(y,"background-image","url("+oe+")"),c(s,"class","inner-grid svelte-pfeueb"),c(e,"class","outer-grid svelte-pfeueb")},m(k,J){z(k,e,J),r(e,i),r(e,t),r(e,s),r(s,n),r(n,l),r(s,_),r(s,p),r(p,w),r(s,d),r(s,f),r(f,g),r(s,T),r(s,y),r(y,$),u||(b=[j(n,"click",a[1]),j(p,"click",a[2]),j(f,"click",a[3]),j(y,"click",a[4])],u=!0)},p:M,i(k){h||I(()=>{h=Y(e,P,{x:-400,duration:500}),h.start()})},o:M,d(k){k&&O(e),u=!1,X(b)}}}function ve(a,e,i){let t,s;E(a,W,d=>i(5,t=d)),E(a,B,d=>i(6,s=d)),window.scrollTo(0,0);function n(d){for(let f=1;f<t.length-1;f++)x(W,t[f].visible=!1,t);x(W,t[d].visible=!0,t),x(B,s=t[d].name,s)}return[n,()=>n(2),()=>n(3),()=>n(4),()=>n(6)]}class be extends S{constructor(e){super();C(this,e,ve,ge,N,{})}}function ye(a){let e,i;return{c(){e=o("div"),e.innerHTML=`<iframe src="https://pods.netlify.app/" width="360" height="700" class="svelte-1k2yd30"></iframe> 
    ...
    <div class="grid-content svelte-1k2yd30"><h2>Simple calculator</h2> 
        ...
        <h3>Technology stack</h3> 
        <p>This app is built with javascript, css, and html.</p><br/></div>`,c(e,"class","grid svelte-1k2yd30")},m(t,s){z(t,e,s)},p:M,i(t){i||I(()=>{i=Y(e,P,{x:-400,duration:500}),i.start()})},o:M,d(t){t&&O(e)}}}function ke(a){return window.scrollTo(0,0),[]}class _e extends S{constructor(e){super();C(this,e,ke,ye,N,{})}}function we(a){let e,i;return{c(){e=o("div"),e.innerHTML=`<img src="/images/giddy-grocery.jpg" class="svelte-sqtg0y"/> 
    ...
    <div class="grid-content svelte-sqtg0y"><h2>Car rental fake business</h2> 
        ...
        <h3>Technology stack</h3> 
        <p>This website is built with javascript, jquery, json, css, and html.</p><br/></div>`,c(e,"class","grid svelte-sqtg0y")},m(t,s){z(t,e,s)},p:M,i(t){i||I(()=>{i=Y(e,P,{x:-400,duration:500}),i.start()})},o:M,d(t){t&&O(e)}}}function Te(a){return window.scrollTo(0,0),[]}class je extends S{constructor(e){super();C(this,e,Te,we,N,{})}}function qe(a){let e,i;return{c(){e=o("div"),e.innerHTML=`<img class="persona svelte-12ypox" src="./images/persona-final.png" alt=""/> 
    ...
    <div class="grid-content"><h2>Hi Doge app flow</h2> 
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid esse eligendi 
            laudantium maiores, dolore maxime iusto molestias error vel velit magnam tempora 
            distinctio aut amet fugiat nihil doloribus tenetur temporibus!</p></div>`,c(e,"class","grid svelte-12ypox")},m(t,s){z(t,e,s)},p:M,i(t){i||I(()=>{i=Y(e,P,{x:-400,duration:500}),i.start()})},o:M,d(t){t&&O(e)}}}function $e(a){return window.scrollTo(0,0),[]}class Le extends S{constructor(e){super();C(this,e,$e,qe,N,{})}}function Ae(a){let e,i;return{c(){e=o("div"),e.innerHTML=`<img src="./images/choco-profile.jpg" alt="" class="svelte-19x6bx6"/> 
    ...
    You can contact me at <a href="mailto: tasmankingsley@gmail.com" style="color: #d3c7b8;">tasmankingsley@gmail.com</a></p>`,c(e,"class","content-div svelte-19x6bx6")},m(t,s){z(t,e,s)},p:M,i(t){i||I(()=>{i=Y(e,P,{x:-400,duration:500}),i.start()})},o:M,d(t){t&&O(e)}}}class Me extends S{constructor(e){super();C(this,e,null,Ae,N,{})}}var ne="/assets/background-dark.f1a90866.png",De="/assets/background-light.fa5a2698.png";const{window:Q}=de;function re(a){let e,i,t,s,n,l,_,p,w,d,f,g,T,y,$;return{c(){e=o("div"),i=o("div"),i.innerHTML='<span class="btn-txt svelte-1q2y0jf">Home</span>',t=q(),s=o("div"),s.innerHTML='<span class="btn-txt svelte-1q2y0jf">Web app projects</span>',n=q(),l=o("div"),l.innerHTML='<span class="btn-txt svelte-1q2y0jf">Website projects</span>',_=q(),p=o("div"),p.innerHTML='<span class="btn-txt svelte-1q2y0jf">Design portfolio</span>',w=q(),d=o("div"),d.innerHTML='<span class="btn-txt svelte-1q2y0jf">About</span>',c(i,"class","nav-btn svelte-1q2y0jf"),c(s,"class","nav-btn svelte-1q2y0jf"),c(l,"class","nav-btn svelte-1q2y0jf"),c(p,"class","nav-btn svelte-1q2y0jf"),c(d,"class","nav-btn svelte-1q2y0jf"),c(e,"class","nav svelte-1q2y0jf"),A(e,"background-image","url("+oe+")")},m(h,u){z(h,e,u),r(e,i),r(e,t),r(e,s),r(e,n),r(e,l),r(e,_),r(e,p),r(e,w),r(e,d),T=!0,y||($=[j(i,"click",a[8]),j(s,"click",a[9]),j(l,"click",a[10]),j(p,"click",a[11]),j(d,"click",a[12])],y=!0)},p:M,i(h){T||(I(()=>{g&&g.end(1),f=Y(e,P,{x:400,duration:500}),f.start()}),T=!0)},o(h){f&&f.invalidate(),g=ce(e,P,{x:400,duration:500}),T=!1},d(h){h&&O(e),h&&g&&g.end(),y=!1,X($)}}}function xe(a){let e,i;return e=new Me({}),{c(){F(e.$$.fragment)},m(t,s){K(e,t,s),i=!0},i(t){i||(D(e.$$.fragment,t),i=!0)},o(t){H(e.$$.fragment,t),i=!1},d(t){V(e,t)}}}function He(a){let e,i;return e=new Le({}),{c(){F(e.$$.fragment)},m(t,s){K(e,t,s),i=!0},i(t){i||(D(e.$$.fragment,t),i=!0)},o(t){H(e.$$.fragment,t),i=!1},d(t){V(e,t)}}}function We(a){let e,i;return e=new je({}),{c(){F(e.$$.fragment)},m(t,s){K(e,t,s),i=!0},i(t){i||(D(e.$$.fragment,t),i=!0)},o(t){H(e.$$.fragment,t),i=!1},d(t){V(e,t)}}}function Ge(a){let e,i;return e=new _e({}),{c(){F(e.$$.fragment)},m(t,s){K(e,t,s),i=!0},i(t){i||(D(e.$$.fragment,t),i=!0)},o(t){H(e.$$.fragment,t),i=!1},d(t){V(e,t)}}}function Pe(a){let e,i;return e=new be({}),{c(){F(e.$$.fragment)},m(t,s){K(e,t,s),i=!0},i(t){i||(D(e.$$.fragment,t),i=!0)},o(t){H(e.$$.fragment,t),i=!1},d(t){V(e,t)}}}function ze(a){let e=!1,i=()=>{e=!1},t,s,n,l,_,p,w,d,f,g,T=a[2][0].visible?"\u292B":"=",y,$,h,u,b,k,J,R;I(a[7]);let v=a[2][0].visible&&re(a);const Z=[Pe,Ge,We,He,xe],G=[];function ee(m,L){return m[2][1].visible?0:m[2][2].visible?1:m[2][3].visible?2:m[2][4].visible?3:m[2][6].visible?4:-1}return~(u=ee(a))&&(b=G[u]=Z[u](a)),{c(){s=o("div"),v&&v.c(),n=q(),l=o("div"),_=o("span"),p=te(a[3]),w=q(),d=o("span"),d.textContent="\u262F",f=q(),g=o("span"),y=te(T),$=q(),h=o("div"),b&&b.c(),c(_,"class","title svelte-1q2y0jf"),c(d,"class","mode svelte-1q2y0jf"),c(d,"style",""),c(l,"class","header svelte-1q2y0jf"),A(l,"background-color",a[1]?"#191a22":"#eee"),A(l,"color",a[1]?"#eee":"#1e1f29"),c(g,"class","burg svelte-1q2y0jf"),A(g,"color",a[1]?"#fff":"#1e1f29"),c(h,"class","content svelte-1q2y0jf")},m(m,L){z(m,s,L),v&&v.m(s,null),r(s,n),r(s,l),r(l,_),r(_,p),r(l,w),r(l,d),r(s,f),r(s,g),r(g,y),r(s,$),r(s,h),~u&&G[u].m(h,null),k=!0,J||(R=[j(Q,"scroll",()=>{e=!0,clearTimeout(t),t=setTimeout(i,100),a[7]()}),j(d,"click",a[6]),j(g,"click",a[4])],J=!0)},p(m,[L]){L&1&&!e&&(e=!0,clearTimeout(t),scrollTo(Q.pageXOffset,m[0]),t=setTimeout(i,100)),m[2][0].visible?v?(v.p(m,L),L&4&&D(v,1)):(v=re(m),v.c(),D(v,1),v.m(s,n)):v&&(ae(),H(v,1,1,()=>{v=null}),se()),(!k||L&8)&&ie(p,m[3]),(!k||L&2)&&A(l,"background-color",m[1]?"#191a22":"#eee"),(!k||L&2)&&A(l,"color",m[1]?"#eee":"#1e1f29"),(!k||L&4)&&T!==(T=m[2][0].visible?"\u292B":"=")&&ie(y,T),(!k||L&2)&&A(g,"color",m[1]?"#fff":"#1e1f29");let U=u;u=ee(m),u!==U&&(b&&(ae(),H(G[U],1,1,()=>{G[U]=null}),se()),~u?(b=G[u],b||(b=G[u]=Z[u](m),b.c()),D(b,1),b.m(h,null)):b=null)},i(m){k||(D(v),D(b),k=!0)},o(m){H(v),H(b),k=!1},d(m){m&&O(s),v&&v.d(),~u&&G[u].d(),J=!1,X(R)}}}function Ie(a,e,i){let t,s;E(a,W,h=>i(2,t=h)),E(a,B,h=>i(3,s=h)),pe(()=>window.scrollTo(0,0));let n;x(B,s=t[1].name,s);let l=!0;document.body.classList.add("dark"),window.visualViewport.width>500&&(document.body.style.backgroundImage=`url(${ne})`);function _(){x(W,t[0].visible=!t[0].visible,t)}function p(h){for(let u=1;u<t.length-1;u++)x(W,t[u].visible=!1,t);x(W,t[h].visible=!0,t),x(B,s=t[h].name,s),x(W,t[0].visible=!t[0].visible,t)}function w(){i(1,l=!l),l===!0?(document.body.classList.replace("light","dark"),window.visualViewport.width>500&&(document.body.style.backgroundImage=`url(${ne})`)):l===!1&&(document.body.classList.replace("dark","light"),window.visualViewport.width>500&&(document.body.style.backgroundImage=`url(${De})`))}function d(){i(0,n=Q.pageYOffset)}return[n,l,t,s,_,p,w,d,()=>p(1),()=>p(2),()=>p(3),()=>p(4),()=>p(6)]}class Oe extends S{constructor(e){super();C(this,e,Ie,ze,N,{})}}new Oe({target:document.getElementById("app")});
